...
| Charmed | - | - Cannot attack enemies Charming the character.<br />- A character may be Charmed by multiple enemies at a time.<br />- Automatically ends if attacked by an enemy Charming the character.
| Dazed | (something) | - Grants Advantage _(+2 to be hit)_<br />- Cannot Flank<br />- Cannot use Opportunity or Immediate Actions<br />- Each turn, can use a Minor Action and either a Standard Action or a Move Action,
| Dazzled | - | - Treats all enemies as having Concealment _(-2 to hit them)_ or, if already in Concealment, as having Superior Concealment _(an additional -3 to hit them)_.
...
| Unconscious | No | - When a character falls unconscious, they are knocked prone.  <br />-When damaged, if the character has 1 or more remaining hit points after receiving the damage, the condition ends.  <br />- Helpless _(+2 to be hit, enemy melee attacks gain +10 Crit Range)_  <br />- Cannot take actions  <br />- Cannot see.
...
| Fatigued | -| - Damage dealt is reduced by 1/4 <br />- Healing granted or received is reduced by 1/4 <br />- Shield Points granted or received are reduced by 1/4

Stealth conditions - These conditions are used by characters trying to hide in combat. Usually, a character enters these conditions voluntarily.
Condition | Effects | Ends
| --- | -------- | -----
...
Special conditions - These conditions are rarely used, typically by monsters.
