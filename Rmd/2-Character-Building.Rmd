...
printClassTitle <- function (className, build, skipClass=FALSE)
{
  cat("<w:p><w:r><w:br w:type=\"page\"/></w:r></w:p>")
  cat("<p><!-- pagebreak --></p>")
  if(!skipClass)
    {cat(paste('<h2>', className,'</h2>',sep=""))}
  cat(paste('<h3>Build: ', className," ", build,'</h3>',sep=""))
}

printClass <- function (class)
{
...
```{r, echo=FALSE, results='asis', message=FALSE, warning=FALSE, prompt=FALSE}
printClassTitle('Barbarian', 'Rager')
printClass(classList$Barbarian$Rager)
printClassTitle('Fighter', 'Guardian')
printClass(classList$Fighter$Guardian)
printClassTitle('Priest', 'of Light')
printClass(classList$Priest$Light)
printClassTitle('Rogue', 'Scoundrel')
printClass(classList$Rogue$Scoundrel)
printClassTitle('Wizard', 'Elementalist')
printClass(classList$Wizard$Elementalist)
printClassTitle('Warlord', 'Tactician')
printClass(classList$Warlord$Tactician)
printClassTitle('Warlock', 'of Shadow')
printClass(classList$Warlock$Shadow)
```
### {.newPage}
### {.newPage}
