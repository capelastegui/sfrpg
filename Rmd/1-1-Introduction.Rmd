...
Why did we choose to call our game Square Fireballs? What does that even mean? The following figure illustrates the reasoning behind the name:
...
grid.raster(img1,interpolate=FALSE,x=0.3,width=unit(0.25, "npc"))
grid.raster(img2,interpolate=FALSE,x=0.7,width=unit(0.25, "npc"))
