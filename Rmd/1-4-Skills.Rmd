...
Abreviation | Check level | DC | Req. Level | Stamina cost
-- | -- | -- | -- | --
R | Routine | - |   |  
...
- Medium - Non-trivial effort for untrained characters, trained characters will handle it most of the time.
- Hard - This is the most an individual without special training can achieve, with luck. Requires effort even from experts.
