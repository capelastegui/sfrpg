...
```{r, echo=FALSE, results='asis', message=FALSE, warning=FALSE, prompt=FALSE}
df_monster_race <- read_csv_monster("monster_races") %>%
  dplyr::filter(Level %>% as.numeric()<11, category=='Standard', subcategory %in% c('Aberration', 'Plant'))
htm_monster_race <- get_htm_monster_race(df_monster_race)  %>%
    get_monster_list_htm()
htm_monster_race %>% cat()
```
...
```{r, echo=FALSE, results='asis', message=FALSE, warning=FALSE, prompt=FALSE}
df_monster_race <- read_csv_monster("monster_races") %>%
  dplyr::filter(Level %>% as.numeric()<11, category=='Minion', subcategory %in% c('Plant'))
htm_monster_race <- get_htm_monster_race(df_monster_race)  %>%
    get_monster_list_htm()
htm_monster_race %>% cat()
```
...
```{r, echo=FALSE, results='asis', message=FALSE, warning=FALSE, prompt=FALSE}
df_monster_race <- read_csv_monster("monster_races") %>%
  dplyr::filter(Level %>% as.numeric()<11, category=='Solo', subcategory=='Dragon')
htm_monster_race <- get_htm_monster_race(df_monster_race)  %>%
    get_monster_list_htm()
htm_monster_race %>% cat()
```

### Solo Monster Classes
