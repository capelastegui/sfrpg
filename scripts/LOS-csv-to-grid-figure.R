...
example1.line.df <- meltGridCsv(file.path(basedir,"raw","Grid-LOS-example-1-no-blocking-lines.csv"))
...
example4.line1.df <- meltGridCsv(file.path(basedir,"raw","Grid-LOS-example-4-wall-line1.csv"))
example4.line2.df <- meltGridCsv(file.path(basedir,"raw","Grid-LOS-example-4-wall-line2.csv"))

plot1.file <- file.path(basedir,"raw","Grid-LOS-example-1-no-blocking.csv")

plotGridLOS(example1.df, plotLOS(example1.line.df))
ggsave(file.path(basedir,"figures","Grid-LOS-example-1-no-blocking.png"))
plotGridLOS(example2.df,plotLOS(example1.line.df,color2="darkred"))
ggsave(file.path(basedir,"figures","Grid-LOS-example-2-no-blocking.png"))
plotGridLOS(example3.df,plotLOS(example1.line.df,color1="darkred",color2="darkred"))
ggsave(file.path(basedir,"figures","Grid-LOS-example-3-blocking.png"))
...
ggsave(file.path(basedir,"figures","Grid-LOS-example-4-wall.png"))
...
ggsave(file.path(basedir,"figures","Grid-cover-example-1-diag.png"))
plotGrid(example.cover2.df)
ggsave(file.path(basedir,"figures","Grid-cover-example-2-diag-non-adj.png"))
