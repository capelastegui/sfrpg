...
power.raw <- file.path(basedir,"raw","charactercreation","Class-Powers-raw.csv")
power.tag <- file.path(basedir,"raw","charactercreation","Powers-tags.csv")
css.file <- file.path(basedir,"Rmd","SFRPG.css")

class.stat.raw <- file.path(basedir,"raw","charactercreation","Race-stats.csv")
class.stat.htm.file  <- file.path(basedir,"html","CharacterCreation","Race-stats.html")

class.features.raw <- file.path(basedir,"raw","charactercreation","Race-features.csv")
class.features.tag <- file.path(basedir,"raw","charactercreation","Race-features-tags.csv")

power.htm.file <- file.path(basedir,"html","CharacterCreation","Class-Powers.html")
power.table.htm.file <- file.path(basedir,"html","CharacterCreation","Class-Powers-table.html")
